...
<div class="container">
    <div class="row justify-content-center g-3">
        <!--<div class="col-md-10 offset-md-1">
            <div class="row ">-->
                <div class="col-md-5 offset-md-1 d-lg-block">
                    ...
                    <div class="row justify-content-center d-flex align-items-center ">
                        ...
                        <div class="col-lg-6 p-5 text-secondary">
                            ...
                            <div class="d-grid gap-2">
                                <a href="#" class=" btn _black">
                                    <span class="text-start"><i class="bi bi-google"></i></span><span class="fw-bold text-center">Sign in with google</span>
                                </a>
                            </div>
